...
namespace RPG.Combat
{
    public class Fighter : MonoBehaviour, IAction, ISaveable, IModifierProvider
    {
        ...
        public bool CanAttack(GameObject currentTarget)
        {
            ...
            if (!GetComponent<Mover>().CanMoveTo(currentTarget.transform.position) &&
                !GetIsInRange(currentTarget.transform)) { return false; }
            Health targetToTest = currentTarget.GetComponent<Health>();
